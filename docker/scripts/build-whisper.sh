...
python3 build.py --output_dir whisper_model --use_gpt_attention_plugin --use_gemm_plugin --use_bert_attention_plugin --model_name distil-whisper-medium-th > /dev/null 2>&1
