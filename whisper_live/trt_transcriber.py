...
from whisper_live.whisper_utils import load_audio_wav_format, mel_filters, pad_or_trim
...
class WhisperEncoding:
    ...
    def get_audio_features(self, mel):
        ...
        inputs.update({"x": mel})
        output_list.append(TensorInfo("x", str_dtype_to_trt(self.dtype), mel.shape))
...
class WhisperTRTLLM(object):
    ...
    def __init__(self, engine_dir, debug_mode=False, assets_dir=None, device=None):
        world_size = 1
